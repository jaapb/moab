...
val get_sessions: string -> int64 option -> (int64 * int64 * string * int * Time.t * Time.t * string option * int option) list Lwt.t
...
val get_week_sessions: string -> int64 -> int -> int64 list Lwt.t
